...
#undef TRADITIONAL    /* but leave LINT_ARGS and ANSI undefined */
#define ANSI 1
#ifdef LINT_ARGS
	...
	void cntab2(int **, int, int, float *, float *, 
		float *, float *, float *, float *, float *, float *);
	void convlv_n(float *, int, float **, int, int, float *);
...
/*	float erfc(float); */
	...
	void  cntab2(int **nn, int ni, int nj, float *h, float *hx, float *hy, 
		...
		float *uxy);
	void convlv_n(float *data, int n, float **respns_n, 
		      int m, int n_rspns, float *ans);
